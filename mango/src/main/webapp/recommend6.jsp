	 ...
	 <div class="container">
      <div class="heading_container">
        ...
        <div>
         	...
         	<div style="margin-top: 30px; font-family: 'S-CoreDream-3Light'; color: black;"><span style = "color: #2846F9;">향수</span>를 <span style = "color: #2846F9;">사용할 시간</span>을 알려주세요.</div>
        </div>
      </div>
    </div>
